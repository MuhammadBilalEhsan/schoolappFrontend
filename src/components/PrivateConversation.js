...
const PrivateConversation = ({ curUser, id, allConversationsArray }) => {
    ...
    return (
        ...
        >
            ...
            <Box display="flex" justifyContent="flex-end" pb={1} pr={2} width="100%" >
                <Button startIcon={<BiArrowBack size="22px" color="white" />} variant="contained" onClick={() => history.push("/messages")} size="small" color="success" sx={{ borderRadius: 5 }}>
                    Back
                </Button>
            </Box>
            <Box display="flex" borderBottom="1px solid #00800085" justifyContent="flex-start" pb={1} pl={2} width="100%" >
                <Typography variant="h5" color="green" sx={{ textTransform: "capitalize" }}>
            ...
            <Box width="100%" display="flex" flexDirection={"column"} minHeight="71vh" px={1.5} >
